...
public class WEnvironment  {
	 ...
	 */
	public WEnvironment(WikipediaConfiguration conf, boolean threaded) throws Exception {
	...
	private WEnvironment(WikipediaConfiguration conf) throws DatabaseException {
	 ...
	 */
	public Long retrieveStatistic(StatisticName sn) throws DatabaseException {
	 ...
	 */
	public TIntHashSet getValidArticleIds(int minLinkCount, ProgressTracker tracker) throws DatabaseException {
	 ...
	 * @throws java.io.IOException if any of the required files cannot be read
	 * @throws javax.xml.stream.XMLStreamException if the XML dump of wikipedia cannot be parsed
	 */
	public static void buildEnvironment(WikipediaConfiguration conf, File dataDirectory, boolean overwrite) throws Exception, XMLStreamException, DatabaseException {
	 ...
	 * 
	 * @see LabelDatabase#prepare(java.io.File, int)
	 * 
	 * @param tp a text processor
	 * @param conf a configuration specifying where the databases are to be stored, etc.
	 ...
	 * @throws java.io.IOException if the temporary directory is not writable
	 */
	public static void prepareTextProcessor(TextProcessor tp, WikipediaConfiguration conf, File tempDirectory, boolean overwrite, int passes) throws Exception {
