...
public abstract class WDatabase<K,V> {
	...
	/**
	 * Creates or connects to a database, whose name will match the given {@link org.wikipedia.miner.db.WDatabase.DatabaseType}
	 * 
	 ...
	 */
	public V retrieve(K key) throws DatabaseException {
	 ...
	 * @throws java.io.IOException if there is a problem decoding the record
	 */
	 ...
	 * @throws java.io.IOException if there is a problem reading or deserialising the given data file.
	 */
	public void loadFromCsvFile(File dataFile, boolean overwrite, ProgressTracker tracker) throws IOException, DatabaseException {
	...
	protected Database getDatabase(boolean readOnly) {
