...
public class Page implements Comparable<Page> {
	 ...
	 */
	public String getMarkup() throws DatabaseException {
	 ...
	 */
	public Integer[] getSentenceSplits() throws DatabaseException {
	 ...
	 */
	public String getSentenceMarkup(int index) throws DatabaseException {
	 ...
	 */
	public String getFirstParagraphMarkup() throws DatabaseException {
	 ...
	 */
	public static Page createPage(WEnvironment env, int id) throws DatabaseException {
