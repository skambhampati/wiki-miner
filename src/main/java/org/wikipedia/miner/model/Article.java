...
public class Article extends Page {
	...
	/**
	 * Returns an array of {@link org.wikipedia.miner.model.Article Articles} that link to this article. These
	...
	/**
	 * Returns an array of {@link org.wikipedia.miner.model.Article}s, sorted by article id, that this article
	...
	/**
	 * Returns an array of {@link org.wikipedia.miner.model.Article.Label Labels} that have been used to refer to this article.
	 * They are sorted by the number of times each label is used.
	 * 
	 * @return an array of {@link org.wikipedia.miner.model.Article.Label Labels} that have been used to refer to this article.
	 */
	...
	/**
	 * A label that has been used to refer to the enclosing {@link org.wikipedia.miner.model.Article}. These are mined from the title of the article, the
	...
	public class Label {
		...
		/**
		 * @return the number of pages that contain links that associate this label with the enclosing {@link org.wikipedia.miner.model.Article}.
		 */
		...
		/**
		 * @return the number of times this label occurs as the anchor text in links that refer to the enclosing {@link org.wikipedia.miner.model.Article}.
		 */
		...
		/**
		 * @return true if this label matches the title of the enclosing {@link org.wikipedia.miner.model.Article}, otherwise false.
		 */
		...
		/**
		 * @return true if there is a {@link Redirect} that associates this label with the enclosing {@link org.wikipedia.miner.model.Article}, otherwise false.
		 */
		...
		/**
		 * @return true if the enclosing {@link org.wikipedia.miner.model.Article} is the primary, most common sense for the given label, otherwise false.
		 */
